  ...
  class PackageHelper
    ...
    def packages
      @packages ||= Mash.new(
        ...
        case nt_version
          when 6.2 then { '4.5.2' => 'KB2901982', '4.6' => 'KB3045562', '4.6.1' => 'KB3102439' }
          when 6.3 then { '4.5.2' => 'KB2934520', '4.6' => 'KB3045563', '4.6.1' => 'KB3102467' }
          when 10 then { '4.6.1' => 'KB3102495' }
          else {}
        end.each { |v, kb| packages[v][:not_if] = "wmic QFE where HotFixID='#{kb}' | FindStr #{kb}" }
      end
    end
